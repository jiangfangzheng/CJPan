...
import com.whut.pan.service.impl.FileServiceImpl;
...
public class ShareController {
    ...
    /**
     * 保存到网盘的接口 目前不能重命名和移动 维护困难 暂时不用
     */
//    @RequestMapping("saveTopan")
//    @ResponseBody
//    public FileSave SaveToPan(String link, HttpServletRequest request){
//        User user = (User) request.getSession().getAttribute("user");
//        String userName = user.getUserName();
...
//        if (saveService.findFileSaveByLocalLink(localLink)==null) {
...
//    }
    ...
    @ResponseBody
    public ResponseMsg shareToMyPan(HttpServletRequest request,
        ...
        if (user==null){
            ...
            System.out.println(userName+" "+downloadLink+" "+path);
    ...
    @ResponseBody
    public ResponseMsg shareToMyPan(HttpServletRequest request,HttpServletResponse response,
                                           String filename,String downloadPath) throws FileNotFoundException, UnsupportedEncodingException {
        // 读到流中
